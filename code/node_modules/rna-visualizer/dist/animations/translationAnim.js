...
export class TranslationAnim {
     ...
     */
    do(elapsed) {
        const update = (start, target) => start * (1 - elapsed) + (target) * elapsed;
...
//# sourceMappingURL=translationAnim.js.map