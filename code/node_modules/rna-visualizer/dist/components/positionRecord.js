...
export class PositionRecord {
     ...
     */
    constructor(labelLines, labelTexts, residues) {
     ...
     */
    static fromDataContainer(container) {
     ...
     * @returns A new PositionRecord object.
     */
    static fromTemplate(container, template) {
        const labelLines = new Map();
        const labelTexts = new Map();
        const residues = new Map();
        container.residues.forEach(res => {
     ...
     * @returns A new PositionRecord object.
     */
    static fromTranslation(container, shift) {
        const labelLines = new Map();
        const labelTexts = new Map();
        const residues = new Map();
        container.residues.forEach(res => {
...
//# sourceMappingURL=positionRecord.js.map